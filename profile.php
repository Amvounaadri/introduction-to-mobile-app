...
<header class="grad-header">
    ...
    <div class="main">
        <div class="">
            <div class="">
                <p class="page_title mb-0"><i class="fa fa-arrow-left mr-4" style="color:#b80e0e;"></i><?php echo $profileData->username; ?></p>
                    ...
                    <div class="profile-body">
                        ...
                        <div class="profile-text">
                            ...
                            <div class="profile-link d-flex mt-3">
                                ...
                                <h6><i class="fa fa-link mr-2"></i><a class="mr-4" href="<?php echo $profileData->website; ?>" target="_blank" style="color:rgba(29,161,242,1.00);"><?php echo $profileData->website; ?></a></h6>
                                <?php } ?>
                            ...
                            <div class="profile-follow mt-2 d-flex">
                                <h6 style="font-weight: 700;">
                                    ...
                                    <a style="color:rgb(91, 112, 131);">Articles</a>
                                </h6>
                            </div>
                        </div>
                    </div>
